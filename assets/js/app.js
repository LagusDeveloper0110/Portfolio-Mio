...
<a class="navbar-brand" href="index.html">Lagus Developer </a>
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    <div class="container-fluid quote-container">
      ...
      <p class="tag" >Hard work trumps talent when talent fails to work hard. - Kevin Durant</p>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <img class="experience-img" width="90%" height="80%" src="./assets/images/footer.png" alt="Development">
          </div>
          ...
          <div class="form-style-6">
             <div class="form-header">
                ...
                <ul class="contactList">
                  <li class="contactItem">Address: San Juan, Tibás, San Jose, Costa Rica</li>
                  <li class="contactItem">Phone: <a href="tell:+506 7083 8987" class="contactLink">+506 7083 8987</a></li>
                  <li class="contactItem">Email: <a href="mailTo:lagusdeveloper0110@gmail.com" class="contactLink">lagusdeveloper0110@gmail.com</a></li>
                </ul>
                </form>
              </div>
            </div>
    ...
    <a class="social-button twitter" href="https://twitter.com/LagusDeveloper" target="_blank">
    ...
    <a class="social-button linkedin" href="https://www.linkedin.com/in/l%C3%A1zaro-guerra-su%C3%A1rez-lagusdeveloper/" target="_blank" >
    ...
    <a class="social-button instagram" href="https://www.instagram.com/lagusdeveloper/" target="_blank" >
    ...
    <a class="social-button github" href="https://github.com/LagusDeveloper0110" target="_blank">
